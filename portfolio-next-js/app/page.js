...
import Writer from "@/components/Elements/Writer";
        ...
        <div className="px-6 flex md:items-center md:px-0 lg:flex lg:items-center py-5">
          <div className=" font-montserrat">
            <div className="text-3xl py-2 font-normal dark:text-white md:text-4xl">
              <h2 className="text-2xl font-montserrat font-medium text-[#000]  dark:text-white md:text-5xl">
                I'm Gatwech Nguth
              </h2>
            </div>

            <h3 className=" text-7xl py-1 dark:text-white md:text-6xl">
