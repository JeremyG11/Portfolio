  ...
  return (
    ...
    >
      <div className=" flex flex-col items-center justify-center">
        ...
        <p className="px-6 py-5 md:px-32 text-center text-gray-300 ">
      ...
      <div className="px-20 py-10  grid grid-cols-1 md:grid-cols-3 md:px-0  gap-10">
        <div className="flex flex-col items-center shadow p-5 rounded-md bg-[#083d49e1] justify-between ">
        ...
        <div className="flex flex-col items-center shadow-lg p-5 rounded-md bg-[#083d49e1] justify-between">
          <div className="p-6 rounded-full flex items-center justify-center bg-[#fffbfbad]">
